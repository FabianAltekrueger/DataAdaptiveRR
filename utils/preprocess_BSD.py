...
def prepare_data(patch_size, stride, aug_times=1, image_type='BSD'):
    ...
    output_directory_train = f'images/{image_type}'
    ...
    files.sort()
    output_directory_val = f'images/{image_type}'
    ...
    if image_type == 'BSD':
        ...
        files.sort()
        output_directory_test = f'images/{image_type}'
...
if __name__ == "__main__":
    prepare_data(patch_size=80, stride=10, aug_times=1, image_type="BSD")
