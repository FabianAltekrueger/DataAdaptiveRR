...
import sys
sys.path.append("..")
from models.utils_model import accelerated_gd_batch
...
class DEQFixedPoint(nn.Module):
    ...
    def forward(self, x_noisy, sigma=None, **kwargs):
        ...
        with torch.no_grad():
            z, self.forward_niter_max, self.forward_niter_mean = accelerated_gd_batch(
                                x_noisy, self.model, sigma=sigma, 
                                ada_restart=True, **self.params_fw)
